...
export default function CommunitySettingsPage() {
  ...
  const loadCommunityData = useCallback(async () => {
    try {
      ...
      if (!session?.access_token) {
        setError('You must be logged in to view community settings')
        return
      }
      ...
      if (!communitiesResponse.ok || !communitiesData.success || !communitiesData.communities) {
        setError(communitiesData.error || 'Failed to load communities')
        return
      }
  ...
  const handleSaveSettings = async () => {
    ...
    try {
      ...
      if (!session?.access_token) {
        setError('You must be logged in to update community settings')
        return
      }
  ...
  const handleDeleteCommunity = async () => {
    ...
    try {
      ...
      if (!session?.access_token) {
        setError('You must be logged in to delete community')
        return
      }
      ...
      <Layout>
        <div className="container mx-auto px-4 py-8">
          <div className="text-center py-12">
            ...
            <p className="text-gray-600 mb-6">
              You need admin privileges to access community settings.
            </p>
            <Button onClick={() => router.back()} variant="outline">
              Go Back
            </Button>
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-400">
                    Allow community members to track new music releases from artists
                  </p>
                </div>
              </div>
            </div>
            <div>
              <label className="text-sm font-medium text-gray-500">Community ID</label>
              <Input
              ...
              <p className="text-xs text-gray-500 mt-1">
                This ID is used to join the community and cannot be changed
              </p>
            </div>
            <Button 
      ...
      {inviteLinks.length > 0 && (
        <Card className="mt-6">
          <CardHeader>
            ...
            <CardDescription>
              Share these links to invite people to join your community
            </CardDescription>
          </CardHeader>
          <CardContent>
      ...
      <Card className="mt-6 border-red-200">
        ...
        <CardContent>
          <div className="flex items-center justify-between p-4 border border-red-200 rounded-lg">
            <div>
              <h3 className="font-medium text-red-600">Delete Community</h3>
              ...
              <DialogContent>
                <DialogHeader>
                  ...
                  <DialogDescription>
                    ...
                    All shows, RSVPs, and other data associated with this community will be permanently deleted.
                  </DialogDescription>
                </DialogHeader>
                <DialogFooter>
