    ...
    <Layout>
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        <div className="mb-8">
          ...
          <p className="text-gray-600 mt-2">
            Create a new community to organize shows and events with your friends
          </p>
        </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Fill in the details for your new community. You&apos;ll be the admin and can invite others to join.
          </CardDescription>
        </CardHeader>
        <CardContent>
